...
function handleSearch(event) {
  ...
  if (searchTerm !== '') {
    ...
    // 검색을 한 후 검색 칸을 지움, 화면 상에 중복으로 불러오는 것도 방지
    searchInput.value = '';
  }
}
// window.location.href를 사용했을 땐 여러번 로딩 시도가 되어서 href()를 replace()로 교체하여 한 번만 시도하도록 변경
